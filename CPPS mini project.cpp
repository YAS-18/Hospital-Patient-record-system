...
void Exit(void);//exit function declaration
...
void WelcomeScreen(void) //function for welcome screen
{
	...
	printf("\n\n\n\n\n\n\n\t\t\t\t#########################################################");
	printf("\n\t\t\t\t#\t\t\tWELCOME TO\t\t\t#");
	printf("\n\t\t\t\t#   DR.A.P.J. ABDUL KALAM HOSPITAL MANAGEMENT SYSTEM    #");
	printf("\n\t\t\t\t#########################################################");
...
/* ****** Exit Screen ****** */
void Exit(void)//function to exit
{
	system("cls");
	Title();// call Title function
	printf("\n\n\n\n\n\t\t\tTHANK YOU FOR VISITING .BE HEALTHY. GET WELL SOON.");
	getch();//holds screen
...
while(e<=2);
	if(e>2)
	{
	printf("\n\n\t\t YOU HAVE TRIED MAX 3 TIMES ..... PLEASE TRY AGAIN AFTER SOME TIME.....");
	getch();
    Exit();
	}
...
do
{
	...
	{
		printf("\n\t Invalid Contact number number........ Enter again ..........\n");
		goto D;
	}
	else
	{
...
/* ****** Prescribed Doctor ****** */
	...
	{
		printf("\n\t Invalid Name.....\n\t The max range for first name is 30 and min range is 3....");
		goto F;
	}
	else
	{
